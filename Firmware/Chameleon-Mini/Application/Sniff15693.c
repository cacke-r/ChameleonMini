...
#ifdef SNIFF15693_DISABLE_AUTO_THRESHOLD
/* This will turn off the feature in the Codec */
/* to evaluate the threshold automatically */
/* This should be disabled only, if you receive */
/* no VICC data - or not reliabally */
static bool disable_autothreshold = true;
#else
/* Default behaviour of the Codec */
static bool disable_autothreshold = false;
#endif
