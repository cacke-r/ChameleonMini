...
def main():
    ...
    cmdArgGroup.add_argument("-at",  "--autothreshold",  dest="auto_thres",   action=CmdListAction, metavar="ENABLE/DISABLE", nargs='?', help="EN-/DISABLES Autothreshold for SniffIso15693 Codec")
